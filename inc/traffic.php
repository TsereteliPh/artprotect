...
$html = "UTM_source - $source_array[source], UTM_medium - $source_array[medium]";
$html .= $source_array['campaign'] ? ", UTM_campaign - $source_array[campaign]" : null;
$html .= $source_array['term'] ? ", UTM_term - $source_array[term]" : null;
$html .= $source_array['content'] ? ", UTM_content - $source_array[content]" : null;
